...
class Contact(models.Model):
    ...
    contact_name = models.CharField(max_length=80, null=False, blank=False, validators=[no_alpha])
    contact_email = models.EmailField(max_length=80, null=True, blank=True)
